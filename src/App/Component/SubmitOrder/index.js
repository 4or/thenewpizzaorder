...
import { SendOrderMutation } from "../../service/Graphql/Mutation/index" 
        ...
        return (
            <>
                ...
                <Modal show={this.state.isOpen} onHide={() => this.setState({ isOpen: !this.state.isOpen })}>
                    ...
                    <Modal.Body>
                        <Mutation mutation={SendOrderMutation} onCompleted={data=> this.setState({success: data.SendOrder.success})}>
                            {
